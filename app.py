...
def repopulate():
    with app.app_context():
        ...
        sample_story_points_field_2 = Field(name="StoryPoints", type="IntegerFieldValue", trackerId=1, itemId=2)
        sample_story_points_field_3 = Field(name="StoryPoints", type="IntegerFieldValue", trackerId=1, itemId=3)
