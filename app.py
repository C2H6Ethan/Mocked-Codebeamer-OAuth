...
def repopulate():
    with app.app_context():
        ...
        sample_status = Status(id=50, name="Test Status", type="ChoiceOptionReference")
        db.session.add(sample_status)
        error_status = Status(id=51, name="Error Status", type="ChoiceOptionReference")
        db.session.add(error_status)
        no_error_tracker = Status(id=52, name="No Errors Status", type="ChoiceOptionReference")
        db.session.add(no_error_tracker)
        status_value = CodebeamerEntityReference(id=50, name="Test Status", type="ChoiceOptionReference")
        db.session.add(status_value)
        error_status_value = CodebeamerEntityReference(id=51, name="Error Status", type="ChoiceOptionReference")
        ...
        sample_item_1 =  Item(name="Test Item 1", description="Test Description", descriptionFormat="Wiki", storyPoints=5, tracker_id=1, status_id=50, assignedTo=[sample_user_1], teams=[sample_team_value], owners=[sample_user_1])
        db.session.add(sample_item_1)
        sample_item_2 =  Item(name="Test Item 2", description="Test Description", descriptionFormat="Wiki", storyPoints=5, tracker_id=1, status_id=50, assignedTo=[sample_user_1], teams=[sample_team_value], owners=[sample_user_1])
        db.session.add(sample_item_2)
        sample_item_3 =  Item(name="Test Item 3", description="Test Description", descriptionFormat="Wiki", storyPoints=2, tracker_id=1, status_id=50, assignedTo=[sample_user_2, sample_user_3], teams=[sample_team_value], owners=[sample_user_1])
        db.session.add(sample_item_3)
        team_item = Item(id=542154, name="Rainbow", description="Test Description", descriptionFormat="Wiki", tracker_id=3313417, status_id=50, assignedTo=[], teams=[])
        db.session.add(team_item)
        team_item_2 = Item(id=542153, name="Edelweiss", description="Test Description", descriptionFormat="Wiki", tracker_id=3313417, status_id=50, assignedTo=[], teams=[])
        db.session.add(team_item_2)

        sample_name_field_1 = Field(name="Summary", type="Test Type", trackerId=1, itemId=1)
        sample_name_field_2 = Field(name="Summary", type="Test Type", trackerId=1, itemId=2)
        sample_name_field_3 = Field(name="Summary", type="Test Type", trackerId=1, itemId=3)
        ...
        sample_story_points_field_1 = Field(name="Story Points", type="Test Type", trackerId=1, itemId=1)
