...
def repopulate():
    with app.app_context():
        ...
        sample_owner_field_1 = Field(name="owners", type="UserReference", trackerId=1, itemId=1, values=[user_value_1])
        sample_owner_field_2 = Field(name="owners", type="UserReference", trackerId=1, itemId=2, values=[user_value_1])
        sample_owner_field_3 = Field(name="owners", type="UserReference", trackerId=1, itemId=3, values=[user_value_1])
