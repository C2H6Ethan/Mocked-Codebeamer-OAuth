...
def repopulate():
    with app.app_context():
        ...
        sample_item_1 =  Item(name="Test Item 1", description="Test Description", descriptionFormat="Wiki", storyPoints=5, tracker_id=1, status_id=1, assignedTo=[sample_user_1], teams=[sample_team_value], owners=[sample_user_1])
        db.session.add(sample_item_1)
        sample_item_2 =  Item(name="Test Item 2", description="Test Description", descriptionFormat="Wiki", storyPoints=5, tracker_id=1, status_id=1, assignedTo=[sample_user_1], teams=[sample_team_value], owners=[sample_user_1])
        db.session.add(sample_item_2)
        sample_item_3 =  Item(name="Test Item 3", description="Test Description", descriptionFormat="Wiki", storyPoints=2, tracker_id=1, status_id=1, assignedTo=[sample_user_2, sample_user_3], teams=[sample_team_value], owners=[sample_user_1])
